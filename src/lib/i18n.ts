...
const dict = {
  en: {
    ...
    cancel: 'Cancel',
    editingHint: 'Editing existing parcel — changes will apply to remaining unplaced pieces.',
  ...
  ru: {
    ...
    reset: 'Сброс',
    edit: 'Изм.',
    editParcel: 'Изменить партию',
    saveChanges: 'Сохранить',
    cancel: 'Отмена',
    editingHint: 'Редактирование партии — изменения применятся к ещё не уложенным местам.',
